...
class MyHttpRequestHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        html = html + f"LED 2  - Device is {LED2}<br>"
        html = html + f"<a href=\"/DEV2=ON\"\"><button>Device 2 ON </button></a> <a href=\"/DEV2=OFF\"\"><button>Device 2 OFF </button></a><br><br>"
        html = html + f"\
                        </body>\
                        </html>"
